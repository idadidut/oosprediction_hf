...
temp = list.files(pattern = "032016.TXT")
...
finalexcel <- distinct(finalexcel[,-(4:6)])
...
trainmod= traintest(train, "Ranch")
testmod = traintest(test, "Ranch")
...
write.csv(finaltraintest, file='~/Documents/Rstudio/ranch_1.csv', row.names = F)
